...
const features = [
  {
    name: 'Persiapan Karir',
    description:
      'Siapkan karir kamu dengan mempelajari materi tentang soft skills dan hard skills',
    icon: PencilAltIcon,
  },
  {
    name: 'Fleksibilitas',
    description: 'Kamu dapat mengakses modul kamu kapan saja dan dimana saja',
    icon: HiOutlineClock,
  },
  {
    name: 'Live Chat Admin',
    description: 'Admin akan selalu siap sedia membantu',
    icon: ChatAltIcon,
  },
  {
    name: 'Konten Matang',
    description:
      'Konten disiapkan dengan kematangan dan melewati proses pemeriksaan yang ketat',
    icon: HeartIcon,
  },
];
const metrics = [
  {
    ...
    stat: '800+',
    emphasis: 'Jam Kelas',
    rest: 'telah ditonton berulang kali',
  },
  {
    id: 2,
    stat: '250',
    emphasis: 'Universitas',
    rest: 'menggunakan Campuspedia Academy sebagai tambahan pembelajaran',
  },
  {
    id: 3,
    stat: '98%',
    emphasis: 'Kepuasan customer',
    rest: 'memiliki feedback positif',
  },
  {
    id: 4,
    stat: '150',
    emphasis: 'Kelas Live',
    rest: 'telah berjalan dan membantu ribuan pengguna',
  },
];
        ...
        <main>
              ...
              <div className='relative shadow-xl sm:rounded-2xl sm:overflow-hidden'>
                ...
                <div className='relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8'>
                  <h1 className='text-4xl font-extrabold tracking-tight text-center sm:text-5xl lg:text-6xl'>
                    <span className='block text-white'>Strive your career</span>
                    <span className='block text-indigo-200'>
                      with Online Learning
                    </span>
                  </h1>
                  <p className='max-w-lg mx-auto mt-6 text-xl text-center text-indigo-200 sm:max-w-3xl'>
                    Campuspedia Academy siap mengakomodasi kamu dengan ilmu yang
                    berkualitas
                  </p>
          ...
          <div className='bg-gray-100'>
            <div className='px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8'>
              <p className='text-sm font-semibold tracking-wide text-center text-gray-500 uppercase'>
                Dipercaya oleh universitas ternama di Indonesia
              </p>
              <div className='flex justify-center gap-8 mt-6'>
                <figure className='w-24'>
                  <Image
                    src='/images/uni/its.png'
                    width='1400'
                    height='902'
                    alt='ITS'
                    layout='responsive'
          ...
          <section className=''>
            <div className='max-w-4xl px-4 py-16 mx-auto sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8'>
              <h2 className='text-3xl font-extrabold tracking-tight text-center text-black'>
                Kelas pilihan
              </h2>
          ...
          <div className='bg-gradient-to-r from-purple-800 to-indigo-700'>
            <div className='max-w-4xl px-4 py-16 mx-auto sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8'>
              <h2 className='text-3xl font-extrabold tracking-tight text-white'>
                Mengapa Campuspedia Academy?
              </h2>
              <p className='max-w-3xl mt-4 text-lg text-purple-200'>
                Belajar secara online (daring) menjadi pilihan terbaik di tengah
                pandemi. Teknologi telah hadir memberikan kita kemudahan,
                efektifitas fleksibilitas dalam belajar dan mempersiapkan karir.
                Bersama Campuspedia, kelas online makin seru dengan durasi 90
                menit anti bosan.
              </p>
            ...
            <div className='max-w-4xl px-4 mx-auto sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8'>
              <div className='relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24'>
                ...
                <p className='mt-3 text-3xl font-extrabold text-white'>
                  Dapatkan kelas yang bisa membangun karir kamu dan keterampilan
                  kamu
                </p>
                <p className='mt-5 text-lg text-gray-300'>
                  Campuspedia Academy bertujuan untuk meningkatkan generasi muda
                  bangsa Indonesia untuk bisa meniti karir bersama dengan
                  Campuspedia Academy untuk bisa menjadi pemimpin di masa depan,
                  diawali dengan pembangunan karir bersama konten-konten tentang
          ...
          <div className='px-4 pt-16 pb-8 mx-auto max-w-7xl sm:px-6 lg:pt-24 lg:px-8'>
            ...
            <div className='pt-8 mt-12 border-t border-gray-200 md:flex md:items-center md:justify-between lg:mt-16'>
              ...
              <p className='mt-8 text-base text-gray-400 md:mt-0 md:order-1'>
                &copy; 2021 Campuspedia Academy. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
